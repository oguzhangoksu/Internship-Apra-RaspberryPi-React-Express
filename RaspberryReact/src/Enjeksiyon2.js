...
const Enjeksiyon2 = (props) => {
    ...
    function divide() {
        ...
        props.degerler.map((deger) => {
            if (deger.makineAdi === "Enjeksiyon2") {
                var obje = {
    ...
    function divideCurrent(){
        ...
        props.devices.map((device)=>{
            if(device.makineAdi==="Enjeksiyon2"){
    ...
    return (
        ...
        <div>
            <Header style ={{ margin: 10, fontSize:30}}> Enjeksiyon 2</Header>
